                ...
                <div className="col-md-6">
                    ...
                    <div className="secondrowevents">
                        ...
                        <div className="col-md-6">
                            ...
                            <h4 className="titledetails"> <TbClockCheck className="icons" /> Time: 2/10/2023</h4>
                            <h4 className="titledetails"> <TfiLocationPin className="icons" /> Location: Location Gala Event Club</h4>
                        </div>
